...
def teacher_tab_take_attendance():
    ...
    with col2:
        if st.button(
            ...
            add_photos_dialog(selected_subject_id)
    selected_subject_id = subject_options[selected_subject_label]
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder="ananaryoy")

    teacher_pass_log= st.text_input("Enter password", type='password', placeholder="Enter password",key="pass_log",value="")
    ...
    with btnc1:
        if st.button('Login', icon=':material/passkey:', shortcut='control+enter', width='stretch'):
            if login_teacher(teacher_username, teacher_pass_log):
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder="ananaryoy@123")
    teacher_name = st.text_input("Enter name", placeholder="ananaryoy")

    teacher_pass_reg= st.text_input("Enter password", type='password', placeholder="Enter password",key="pass_reg")
    ...
    with btnc1: 
            if st.button('Register', type='primary', icon=':material/passkey:', width='stretch'):
                success,message=register_teacher(teacher_username,teacher_name,teacher_pass_reg,teacher_pass_confirm)
                if success:
                    st.success(message)
                    import time
                    time.sleep(2)
